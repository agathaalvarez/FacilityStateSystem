...
<div id="wrapper">
	<div class="container">
		...
		<center><p>Message:<br> <input type="text" name="Message" style="height:150px; width:400px; font-size: 12pt" />
<br>
...
{	
	...
	$query = mysql_query("INSERT INTO Announcement (Message, Date,Status) VALUES('$Message',NOW(),'Pending')");
		
	if(mysql_query($query)) 
    {
        echo "<script type='text/javascript'> alert ('Message failed');</script>";
		echo "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"2; URL=addannounce.php\">";
	} 
	else 
	{
		echo "<script type='text/javascript'> alert ('Message successful');</script>";	
		echo "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"2; URL=announcement.php\">";
	}
}
