...
<center><br><form action="addreport.php" method="post">
	<select id = "Disaster" readonly="readonly" name ="Disaster" style="width:300px; height: 50px;">
...
<br>
<br>
<p><input type="number" placeholder="Number of Computer Labs affected" name="coms" style="height:50px; width:300px" /><br><p>
<p><input type="number" placeholder="Number of Temporary Learning Site" name="tls" style="height:50px; width:300px" /><br><p>
...
if (isset($_REQUEST['submit'])) 
{
	...
	else if(($coms)==NULL && $Disaster == "Typhoon")
	{
		$query = mysql_query("INSERT INTO report (Date,Disaster,DisasterType,SchoolName,Computer,TLS,SchoolStatus,file) VALUES(NOW(),'$Disaster','Natural Disaster','$SchoolName','$coms','$tls','Not Affected','$file')");
		...
		echo "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"2; URL=report.php\">";
			...
			$query = mysql_query("INSERT INTO report (Date,Disaster,DisasterType,SchoolName,Computer,TLS,SchoolStatus,image) VALUES(NOW(),'$Disaster','$type','$SchoolName','$coms','$tls','Affected', '$file')");
		if(mysql_query($query)) 
    {
        echo "<script type='text/javascript'> alert ('Report failed');</script>";
		echo "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"2; URL=addreport.php\">";
