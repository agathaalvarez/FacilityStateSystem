...
echo "<td>" . $row['Date'] . "</td>";
echo "<td width='3%'><a href='editannounce.php?AnnouncementID=".$row['AnnouncementID']."'>Edit</td>";
echo "<td width='3%'><a href='deleteannounce.php?AnnouncementID=".$row['AnnouncementID']."'>Delete</td>";
echo "</tr>";
}
echo "</table>";
